...
#  print(length(varincluded));
  ...
  {
      outcomep <- univariate_correlation(data[,c(Outcome,varincluded)],Outcome,method="spearman",limit=0,pvalue=0.20,thr=thr) # the top associated features to the outcome
